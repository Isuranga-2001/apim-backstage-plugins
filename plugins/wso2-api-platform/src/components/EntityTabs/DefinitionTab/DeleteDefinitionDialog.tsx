...
export const DeleteDefinitionDialog = (options: {
  entity: Entity;
  open: boolean;
  onClose: () => void;
  onDeleted: () => void;
}) => {
  const { entity, open, onClose, onDeleted } = options;
  const { submitting, deleteDefinition, snackbar, closeSnackbar } =
    ...
    <>
      <Dialog open={open} onClose={submitting ? undefined : onClose}>
        ...
        <DialogContent>
          ...
          <Typography>
            This API's definition will be permanently deleted from the plugin
