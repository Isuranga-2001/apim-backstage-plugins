...
/**
 * Recursive JSON-Schema-like model for policy parameters, as returned by the
 * Policy Hub's policy-definition endpoint. The config dialog renders one of
 * these recursively.
 */
...
/**
 * Whether any top-level required property is empty (drives the Confirm
